...
This feature is available for Super Admin (SA), Master Licensee (ML), Master Admin (MA), Center Admin (CA) and Trainer roles.
...
![Image](./img/send-email-welcome-6.png)

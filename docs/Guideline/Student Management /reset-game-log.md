---
id: reset-game-log
title: Resetting a Student's Game Log
...
![Image](./img/reset-game-log-1.png)

3.  In the student search field, type **student's name**.
4.  Click the **Search** button.

![Image](./img/reset-game-log-2.png)

5.  Click on the specific student's entry in the search results.

![Image](./img/reset-game-log-3.png)

6.  Click the **Reset** button.

![Image](./img/reset-game-log-4.png)
...
![Image](./img/reset-game-log-5.png)

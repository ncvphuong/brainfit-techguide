---
id: subgame-management
title: Accessing Junior/Smart Moves/Brainfit Baby Sub Games Management on ACP
sidebar_label: Accessing Junior/Smart Moves/Brainfit Baby Sub Games Management on ACP
sidebar_position: 1
---
...
![Image](./img/subgame-management-1.png)

3. Click **"Games"**.  

![Image](./img/subgame-management-2.png)

4. Click **"Junior"** or **"Smart Moves"** or **"Brainfit Baby"**.  

![Image](./img/subgame-management-3.png)

5. Click **"Sub Games"**.  

![Image](./img/subgame-management-4.png)

6. Click **here** to redirect to the level detail view.  

![Image](./img/subgame-management-6.png)
...
7. In this view, you can see the **exact status of attachments** for each level.  
   ...
   ![Image](./img/subgame-management-5.png)
